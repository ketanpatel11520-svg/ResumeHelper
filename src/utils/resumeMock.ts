...
export const defaultResumeData: ResumeData = {
  personalInfo: {
    fullName: "KPatel",
    title: "Computer Specialist Operator",
    email: "kpatel@gmail.com",
    phone: "+91-9889965561",
    location: ", M.P.",
    website: "",
    github: "",
    linkedin: "linkedin.com/in/k-p-25858",
    profilePhoto: "",
    objective: "Motivated, data handling, and technical operations. Experienced in computer systems and communication workflows, seeking to contribute effectively in an entry-level technical or operations role.",
  },
  education: [
    {
      id: "edu-1",
